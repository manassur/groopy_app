...
class ChooseLanguageDialog extends StatefulWidget {
  const ChooseLanguageDialog({Key? key}) : super(key: key);
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 20,),
            Text(UITexts.SELECT_LANGUAGE, style: TextStyle(
            ...
            Container(
                ...
                child: TextFormField(
                  ...
                  decoration: new InputDecoration(
                      ...
                      hintText: UITexts.SEARCH_LANGUAGE,
            ...
            child: Scrollbar(
              ...
              child: ListView.separated(
                ...
                itemCount: UITexts.LANGUAGES.length,
                itemBuilder: (context, index) {
                  return ListTile(
                    title: Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 8.0),
                      child: Text('${UITexts.LANGUAGES[index]}'),
                    ),
                  );
                },
              ),
            ...
            MaterialButton(
              onPressed: (){
                ...
                print('choose language pop up closed');
              },
              height: 62,
